...
return [
    ...
    'Directorio_Card_Gerson_Description' => 'Médico Cirujano de la Universidad de Chile, Especializado Ley 16.744, servicio de urgencias, atención en policlínicos, medicina ocupacional y cuidado de adultos mayores. Experiencia en gestión clínica, gestión de centros de salud y gestión de servicios de urgencias.',
    'Directorio_Card_Fernando_Ocupation' => 'DIRECTOR',
    'Directorio_Card_Fernando_aravena_Description' => 'Ingeniero Comercial de la Universidad Andrés Bello, Diplomado en Desarrollo Organizacional, Diplomado en especializado de Innovación Digital para Recursos Humanos. Cuenta con más de 15 años de experiencia en el área de Gestión de Personas, Compensaciones y Desarrollo Organizacional en industrias de los sectores salud, educación y logística.
                                               Ha desarrollado su carrera profesional en instituciones como RedInterclínica, Clínica Ciudad del Mar, Sociedad Eduacional SIEL, United Cargo Company, liderando proyectos de transformación organizacional, evaluación de desempeño, compensaciones, relaciones laborales y modernización de procesos para dotaciones superiores a 1.200 colaboradores.
                                               Su experiencia combina visión estratégica y capacidad de ejecución, impulsando la eficiencia organizacional, el desarrollo del talento humano y la creación de valor sostenible para las organizaciones.
                                               Su trayectoria en gestión estratégica de personas, control de costos y desarrollo organizacional aporta una visión integral orientada al crecimiento sostenible, la gobernanza corporativa y la generación de valor para accionistas y grupos de interés.',
    'Directorio_Card_Alvaro_Ocupation' => 'DIRECTOR',
    'Directorio_Card_Alvaro_Description' => 'Álvaro Bonich es director de Sudmédica y fundador de Propietario Feliz.
                                              Posee más de 20 años de experiencia en el mercado financiero, gestión de riesgos, gobierno corporativo y desarrollo de negocios, participando en proyectos de alcance nacional e internacional.
    ...
    'EEFF_Consolidado_Sudmedica_2025-2024' => 'EEFF Consolidado Sudmédica 2025-2024 Pdf',
